...
exports.WalletsModule = WalletsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [wallets_resolver_1.WalletsResolver, wallets_service_1.WalletsService, withdrawals_service_1.WithdrawalsService],
        exports: [wallets_service_1.WalletsService, withdrawals_service_1.WithdrawalsService],
    })
], WalletsModule);
